...
class YourModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        print()
        print("MY MSG: STARTING THE MODEL")
        print()
        self.optimizer = tf.keras.optimizers.experimental.SGD(learning_rate=hp.learning_rate,
        ...
        self.architecture = [
              ...
              Conv2D(20, 10, 10, padding="same",
                     activation="relu", name="first_convolve_with_activation"),
              MaxPool2D(2, name="first_max_pool_layer"),
              Flatten(),
