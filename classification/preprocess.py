...
class Datasets():
    ...
    def standardize(self, img):
        ...
        img = (img - self.mean) / self.std      # this is the standardization equation
    ...
    def get_data(self, path, is_vgg, shuffle, augment):
        ...
        # Personal comment: this function maps the name of the directory to each image
        # and generates a random subsample of data.  Since the class_mode is 'sparse'
        # the labels will be 1D integer labels.  If it were 'categorical' it would be 
        # 2D one-hot encoded labels
        ...
        print("idx to class: " + str(self.idx_to_class))
